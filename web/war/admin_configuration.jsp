    ...
    %>
		<div class='contentContainer'>
			<div class='leftContainer' id="manageConfig">
				<div>
					<p class="bold" style="margin-top: 60px;">Select module to manage/configure 
						<select id="configSlct" style="width:200px;">
							<option value="0">--Select--</option>
						    <option value="domain" class="confDomain">Domain</option>
							<option value="vt" class="confVt">Voting threshold</option>
							<option value="lp" class="confLang">Configured language pairs</option>
							<option value="category" class="confCat">Category</option>
							<option value="et" class="confEmailTemplate">Create/Update email template</option>
							<option value="etDel" class="confEmailTemplate">Delete email template</option>
							<option value="roleName" class="mgRole">Manage Roles</option>
							<option value="mgRoles" class="mgPgs">Manage Privileges</option>
						</select>
					</p>
				</div>

(function(window, $j) {
  ...
  var uploadTMXStatus= function(fileIdVal){
		...
		success:function(data){
			  if(data != null&& data.proccesedPercentage==100 && data.fileUrl!=null){	
				  ...
				  $j("#progressMsg").show();
				  	setTimeout(function(){
		        		uploadTMXStatus(fileIdVal);
					},10);
			  } else if(data!=null && data.proccesedPercentage==0 && data.fileStatus=="Invalid TMX File"){
				  $j("#progressbarImp").reportprogress(0); 
				  $j("#InvalidMsg").show();

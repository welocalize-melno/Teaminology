   ...
   /* $j(window).scroll(function () {
    ...
    $j.fn.termDetails = function () {
        ...
        var termDtlTmpl = [
            ...
            '',
            '</div><div class="width40 toppadding5" style="text-align:center"><img src="' + $j("#contextRootPath").val() + '/images/grey_checkmark.png" height="20px" width="20px" class="novisibility tickImg ',
            '',
            ...
            '',
            '</div><div class="width110  toppadding5 tCategory" style="text-align:center">',
            '',
            '</div><div class="width90  toppadding5 tDomain">',
            '',
            //'</div><div class="width80  toppadding5 tcompany viewCompany nodisplay"">',
            '</div><div class="width80  toppadding5 tstatus noWidth">',
            '',
            '</div><div class="width40 toppadding15 modify noWidth"><img class="headerMenuLink modifyImg "  height="20px" width="20px" src="' + $j("#contextRootPath").val() + '/images/Pencil1.png" editId="',
            '',
            '" /></div><div class="width30 toppadding15 delete noWidth" ><img class="headerMenuLink deleteImg" height="20px" width="20px"  src="' + $j("#contextRootPath").val() + '/images/DeleteIcon1.png" imgId="',
            '',
        ...
        var termAttrTmpl = '<div class="termAttr"><div><div><div class="bold sourceTerm label" >Term being polled<span id=#{starId} class="editDetailsFld nodisplay redTxt">*</span>: </div> <div class="sourceDesc viewDetailsFld" style="word-wrap:break-word;"></div><textarea   rows="3" cols="61"   name="editSourceTerm"  id=#{sourceId} class="sourceDescEdit editDetailsFld nodisplay editSourceTerm"  value="" ></textarea><span style="font-size:12px;color-red;position:absolute;padding-left:10px;padding-top:17px;" id=#{errorId} class="error showError nodisplay">Term being polled cannot be empty</span><div class="clear"></div>'
            ...
            + '</div></div><div class="right"><div class="topmargin5"><div class="bold label">Concept definition: </div><div class="definitionDesc viewDetailsFld" style="word-wrap:break-word;" ></div><textarea rows="3" cols="61" id=#{defId} class="definitionDescEdit editDetailsFld nodisplay definition" ></textarea><div class="clear"></div>'
            + '</div><div class="topmargin10"><div class="bold label">Term Usage: </div><div class="usageDesc viewDetailsFld" style="word-wrap:break-word;"></div><textarea rows="3" cols="61"   id=#{usageId}  class="usageDesc editDetailsFld nodisplay" ></textarea>'
        ...
        var editDetailsSec = '<div class="clear"></div><div class="editLinksSec smallFont"><span id="pollSpan"><a href="javascript:;" class="padding5 extendPoll">Extend poll</a><a href="javascript:;" class="padding5 updateDate nodisplay">Update date</a> | </span><a href="javascript:;" class="padding5 editDetails">Edit details</a><a href="javascript:;" class="padding5 updateDetails nodisplay">Update details</a> | <a href="javascript:;" class="padding5 votingDetails">Voting details</a> | <a href="javascript:;" class="padding5 historyDetails">History details</a></div>';
                                    ...
                                    if ($j('#historyDetailsTab').length > 0) {
                                        ...
                                        var oTable = $j('#historyDetailsTab').dataTable({
                                            ...
                                            "aoColumns": [
                                                ...
                                                { "mDataProp": "changedTargetTerm", "sWidth": "10%" },
...
////					
                        ...
                        for (var i = 0; i < length; i++) {
                            ...
                            if (invites == 0 && votesPerTerm == 0) {
                                ...
                                $j("#dataPie_" + termDetails[i].termId).css("width", "40px");
                                $j("#dataPie_" + termDetails[i].termId).removeAttr("id");
                                commonObj.reConfigCssForSmallPie();
                                continue;
                            }
                            // Start of chart object
                            dataXML.push("<chart showPercentValues='1' showLabels='0' showValues='0' pieRadius='14' showShadow='0' slicingDistance='0' animation='0' paletteColors='#C9CCCB, #00A4D6' showBorder='0' bgAlpha='30' showToolTip='0'>");
...
//	};
    ...
    var addNewTerm = function () {
        ...
        if (cvalues != null && cvalues.length > 1 && companyVisible) {
            ...
            termInformation.termProgram = program;
            termInformation.termNotes = $j.trim($j("#termNotes").val());
            termInformation.termLangId = $j("#srcLang :selected").val();;
            termInformation.conceptDefinition = $j.trim($j("#cncptDef").val());
            termInformation.conceptNotes = $j.trim($j("#notes").val());
            termInformation.conceptProdGroup = $j("#productGroup :selected").val();
            termInformation.conceptCatId = $j("#category :selected").val();
...
//				selectedTermIds = ""; 
    ...
    var saveTermDetails = function (termId) {
        ...
        termDtls.conceptDefinition = commonObj.trimMoreThanOnek($j("#defId_" + termId).val());
        termDtls.termUsage = commonObj.trimMoreThanOnek($j("#usageId_" + termId).val());
...
//			var msg="Downloading ... please wait";
    ...
    $j("#progressLink").click(function () {
        ...
        if ($j("#hpsite").val() == "true")
            location.href = $j("#contextRootPath").val() + "/demo/import_export_status.jsp";
        else
...
//			selectedTermIds = "";
        ...
        validateTerm = $j("#addNewTerm").validate({
            ...
            messages: {
                termInfo: "<br/>Source term is required",
                srcLang: "<br/>Select at least one source language",

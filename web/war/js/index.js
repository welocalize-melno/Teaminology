(function (window, $j) {
	...
	var url = $j(location).attr('href');
		...
		if(url.indexOf("app/dashboard.jsp") != -1){
		    $j('.header').addClass('backgroundImage');
		    $j('#signOut').css('margin-top','23px');
    ...
    var slctOptionTmpl = ['<option value="',
        '',
        '" >',
        '',
        '</option>'
...
//				$j('#trgtLang').css("border","1px solid  #BBBBBB");
    ...
    $j('#monthly').click(function () {
        $t.getMonthlyTermsInGlossary({
            success: function (data) {
                var termsPerMonth = data;
                var dataXML = new Array();
                if ($j("#hpsite").val() == "true")
                    dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' divLineColor='#d3d3d3' showAlternateHGridColor='0' plotbordercolor='0e94bc' plotborderthickness='3' anchorbgcolor='0e94bc' anchorborderthickness= '0' showshadow='0' canvasBorderThickness='0' lineThickness='2' baseFont='HP Simplified' lineColor='#0e94bc'>");
                else
                ...
                if (termsPerMonth != null) {
                    for (var count = 0; count < termsPerMonth.length; count++) {
                        dataXML.push("<set label='" + termsPerMonth[count].interval + "' " + "value='" + termsPerMonth[count].termsPerInterval + "'/>");
                    }
                }
                dataXML.push("</chart>");
        ...
        $t.getMonthlyTermsDebated({
            success: function (data) {
                var termsDebatedPerMonth = data;
                var dataXML = new Array();
                if ($j("#hpsite").val() == "true")
                    dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' divLineColor='#d3d3d3' showAlternateHGridColor='0' plotbordercolor='0e94bc' plotborderthickness='3' anchorbgcolor='0e94bc' anchorborderthickness= '0' showshadow='0' canvasBorderThickness='0' baseFont='HP Simplified' lineThickness='2' lineColor='#0e94bc'>");
                else
                    dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' showAlternateHGridColor='0' canvasBorderThickness='0' lineThickness='5px' lineColor='#6ab53a'>");
                if (termsDebatedPerMonth != null) {
                    for (var count = 0; count < termsDebatedPerMonth.length; count++) {
                        dataXML.push("<set label='" + termsDebatedPerMonth[count].interval + "' " + "value='" + termsDebatedPerMonth[count].termsPerInterval + "'/>");
                    }
                }
                dataXML.push("</chart>");
        ...
        $t.getMonthlyTmDetails({
            success: function (data) {
                var tmsPerMonth = data;
                var dataXML = new Array();
                if ($j("#hpsite").val() == "true")
                dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' showAlternateHGridColor='0' divLineColor='#d3d3d3' plotbordercolor='0e94bc' plotborderthickness='3' anchorbgcolor='0e94bc' anchorborderthickness= '0' showshadow='0' canvasBorderThickness='0' baseFont='HP Simplified' lineThickness='2' lineColor='#0e94bc'>");
                else
                	dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' showAlternateHGridColor='0' canvasBorderThickness='0' lineThickness='5px' lineColor='#6ab53a'>");
                if (tmsPerMonth != null) {
                    for (var count = 0; count < tmsPerMonth.length; count++) {
                        dataXML.push("<set label='" + tmsPerMonth[count].interval + "' " + "value='" + tmsPerMonth[count].termsPerInterval + "'/>");
                    }
                }
                dataXML.push("</chart>");
    ...
    $j('#quarterly').click(function () { 
    	
        $t.getQrtrlyTermsInGlossary({
            success: function (data) {
                ...
                if (termsPerQuarter != null) {
                    for (var count = 0; count < termsPerQuarter.length; count++) {
                        dataXML.push("<set label='" + termsPerQuarter[count].interval + "' " + "value='" + termsPerQuarter[count].termsPerInterval + "'/>");
                    }
                }
                dataXML.push("</chart>");
                var chartReference = FusionCharts("myChartId");
        ...
        $t.getQrtrlyTermsDebated({
            success: function (data) {
                var termsDebatedPerQrtr = data;
                var dataXML = new Array();
                if ($j("#hpsite").val() == "true")
                    dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' showAlternateHGridColor='0' divLineColor='#d3d3d3' plotbordercolor='0e94bc' plotborderthickness='3' anchorbgcolor='0e94bc' anchorborderthickness= '0' showshadow='0' canvasBorderThickness='0' lineThickness='2' baseFont='HP Simplified' lineColor='#0e94bc'>");
                else
                    dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' showAlternateHGridColor='0' canvasBorderThickness='0' lineThickness='5px' lineColor='#6ab53a'>");
                if (termsDebatedPerQrtr != null) {
                    for (var count = 0; count < termsDebatedPerQrtr.length; count++) {
                        dataXML.push("<set label='" + termsDebatedPerQrtr[count].interval + "' " + "value='" + termsDebatedPerQrtr[count].termsPerInterval + "'/>");
                    }
                }
                dataXML.push("</chart>");
                var chartReference = FusionCharts("myChartId1");
        ...
        $t.getQuarterlyTmDetails({
            success: function (data) {
                ...
                //dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' showAlternateHGridColor='0' plotbordercolor='0e94bc' plotborderthickness='3' anchorbgcolor='0e94bc' anchorborderthickness= '0' showshadow='0'canvasBorderThickness='0' lineThickness='2' baseFont='HP Simplified' lineColor='#0e94bc'>");
                    dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0'  plotbordercolor='0e94bc' plotborderthickness='3' divLineColor='#d3d3d3' anchorbgcolor='0e94bc' anchorborderthickness= '0' showshadow='0'   showAlternateHGridColor='0' canvasBorderThickness='0' lineThickness='2' baseFont='HP Simplified' lineColor='#0e94bc'>");
                	else
                	 dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' showAlternateHGridColor='0' canvasBorderThickness='0' lineThickness='5px' lineColor='#6ab53a'>");
                if (tmsPerQuarter != null) {
                    for (var count = 0; count < tmsPerQuarter.length; count++) {
                        dataXML.push("<set label='" + tmsPerQuarter[count].interval + "' " + "value='" + tmsPerQuarter[count].termsPerInterval + "'/>");
                    }
                }
                dataXML.push("</chart>");
                var chartReference = FusionCharts("myChartIdTm");
    ...
    $j("#newTermMail").click(function () {
        if ($j("#rqstNewTrm").valid() && values != null && values != 0) {
...
//        		$j(".termRqstBtn").css("padding","1px 25px");
        ...
        $j(".priodLinks span").last().css("border-right", "none");
        ...
        $t.getTermsInGlossary({
            success: function (data) {
                ...
                var dataXML = new Array();
                if ($j("#hpsite").val() == "true")
                    dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0'  divLineColor = '#d3d3d3' plotbordercolor='0e94bc' plotborderthickness='3' anchorbgcolor='0e94bc' anchorborderthickness= '0' showshadow='0' showAlternateHGridColor='0' canvasBorderThickness='0' lineThickness='2' baseFont='HP Simplified' lineColor='#0e94bc'>");
                else
                    dataXML.push("<chart showValues='0' showBorder='0' bgAlpha='0' showAlternateHGridColor='0' canvasBorderThickness='0' lineThickness='5px' lineColor='#6ab53a'>");
      ...
      /*  $j('#about').click(function(){
        	alert("The HP Terminology Community is a social media program aimed at managing and standardizing HP " +

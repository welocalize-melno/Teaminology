(function(window, $j) {
	...
	var domainListTmpl = ['<div class="configLstItem"><div class="width170 viewDtl" id="',
		...
		var tempHtml = 	 '<head><style>' +
						 ...
						 '<tbody>'+
						 '<tr>'+
						 '<td style="padding-top: 30px;" width="80%"><span style="font-family: HP Simplified, Arial !important;font-size: 36px;"><strong>Newell Terminology Community</strong></span></td>'+
						  '</tr>'+
						 '</tbody>'+
						 '</table>'+
						 '<p>&nbsp;</p>';

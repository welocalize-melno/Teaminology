    ...
    $j.fn.tmDetails = function () {
        ...
        var startWaiting = function (msg, selector, floatRight) {
            if (selector) {
                ...
                var temp = '<div class="loading-msg  topmargin15" style="padding-left:330px;"><img src="' + $j("#contextRootPath").val() + '/images/loading.gif" />' + '&nbsp;' + msg + '</div>';
            ...
            $t.searchTMEntries(queryAppenderParameter, {
                success: function (data) {
                    ...
                    if (tmDetails == null || tmDetails.length == 0) {
                        ...
                        $j("#tmDtlRowsList").html('<span style="text-align: center; display: block;  font-size:12px;padding-top:10px; padding-bottom:10px;padding-right:120px;">' + displayCriteriaTm + '</span>');
                        $j("#tmPagination").hide();
            ...
            $t.searchTermBaseEntries(queryAppenderParameter, {
                success: function (data) {
                    ...
                    if (termDetails == null || termDetails.length == 0) {
                        ...
                        $j("#termDtlRowsList").html('<span style="text-align: center; display: block;  font-size:12px;padding-top:10px; padding-bottom:10px;padding-right:120px;">' + displayCriteria + '</span>');
                        $j("#pagination").hide();

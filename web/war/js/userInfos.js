    ...
    var displayUserDetails = function(data) {
        ...
        if($j("#adminHeaderFlag").val() != "true"){
            ...
            if(badgingRate>=0 && badgingRate<50){
                $j("#bagingImgId").html('<img src="'+$j("#contextRootPath").val()+'/images/BeginnerBadge.gif"  style="padding-bottom: 10px;"/> &nbsp; <img src="'+$j("#contextRootPath").val()+'/images/logo_hpe.png" height="40px" width="50px" />');
            }else if(badgingRate>=50 && badgingRate<150){
                $j("#bagingImgId").html('<img src="'+$j("#contextRootPath").val()+'/images/AdvancedBadge.gif"  style="padding-bottom: 10px;"/> &nbsp; <img src="'+$j("#contextRootPath").val()+'/images/logo_hpe.png" height="40px" width="50px" />');
            }else if(badgingRate>=150){
                $j("#bagingImgId").html('<img src="'+$j("#contextRootPath").val()+'/images/ExpertBadge.gif"  style="padding-bottom: 10px;"/> &nbsp; <img src="'+$j("#contextRootPath").val()+'/images/logo_hpe.png" height="40px" width="50px" />');
            }
        }else{
            $j(".userVotes").hide();
        }

...
<body class="export">
    ...
    %>
		<div class='contentContainer'  style="padding-left: 20px; padding-top: 12px;">
		...
		<div class="topmargin15" id="termsModule">
			 ...
			 <div  class="bottommargin10">
						<input type="button" value="Delete Selected" class="commonBtn" name="deleteMultipleGSTerms" id="deleteMultipleGSTerms" style="padding: 3px 10px; margin-top: 25px;"/>&nbsp;&nbsp;

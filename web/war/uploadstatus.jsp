...
<body class="adminOvr">
	...
	<%@include file="./common/header.jsp"%>
		...
		<input type="hidden" id="fileId" value="<%=fileId %>">
			...
			<div id="InvalidMsg" class="nodisplay" style="margin-left: -123px;margin-top: 12px;font-size: 14px;text-align: center;color: red;">
			Invalid TMX File
			</div>
...
<div class='footerTopLine' style="margin-top:80px;"></div>
	...
	<script type="text/javascript" src="<%=application.getContextPath()%>/js/hpTeamList.js"></script>
	 <script type="text/javascript" src="<%=application.getContextPath()%>/js/uploadstatus.js"></script>

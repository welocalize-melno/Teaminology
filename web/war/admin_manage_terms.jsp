...
<input type="hidden" name = "serverDate" id = "serverDate" value = <%=new java.util.Date().getTime()%>>
		...
		<div class='contentContainer'>
			...
			<!-- Tabs -->
				...
				<div id="tabs" class="bottommargin15">
						...
						<div id="tabs-1" class='reportContainerManage' style ="margin-left:-7px">
					...
					<div class='reports'>
					...
					</div><div class="smallFont padding5 alignRight" id="viewRprt"></div>
						</div>
						<div id="tabs-2"class="border-aln">
							...
							<iframe id="uploadFrameID" name="uploadFrame" height="0" width="0" frameborder="0" scrolling="yes"></iframe>
								<form id="ImportForm" name="ImportForm" method="post" target="uploadFrame"   action="<%=application.getContextPath()%>/impExp_serv" ENCTYPE="multipart/form-data">
									...
									<div class="topmargin5">
									 ...
									 <!--  <img id="importFile" src="<%=application.getContextPath()%>/images/document_import.png" height="35px" width="35px;" alt="Click to Import file" title="Click to Import file" style="vertical-align: bottom; margin-left: 30px;cursor:pointer;" /> -->
								     <input type="image" src="<%=application.getContextPath()%>/images/document_import.png" height="35px" width="35px;" alt="Click to Import file" title="Click to Import file" style="vertical-align: bottom; margin-left: 30px;cursor:pointer;" id="importFile"/> 
								 </div> 
								</form>
								<div id="message"></div>
									...
									<div id="entryInfo" class="topmargin5 bottommargin10">
										...
										<!-- 	<div class="topmargin5">
								 			...
								 			<div class="topmargin5 companySlctdropdown  companyFilter nodisplay">
												...
												<div class="floatright nodisplay companySlctErr" style="width:215px;margin-right:69px;"><span class="error companySlctErr">Select at least one company</span></div>
									...
									<div id="sourceInfo" class="topmargin15 bottommargin10">
										...
										<div class="left topmargin5">
											<div>
												...
												<label for="termInfo" class="error floatright nodisplay"  generated="true"></label><div class="clear"></div>
											...
											<div class="topmargin5">
												...
												<label for="termPOS" class="error floatright nodisplay" generated="true"></label><div class="clear"></div>
            ...
            <div class="topmargin10">
                ...
                <select class="text250 termDomain"  name="termDomain"  id="termDomain">
                    <option value="">--Select--</option>
									...
									<div id="targetInfo" class="topmargin15 bottommargin10">
										...
										<div class="left topmargin5">
											<div  style="padding-bottom: 7px">
												...
												<label for="trgtLang" class="error floatright nodisplay" generated="true"></label><div class="clear"></div>
									...
									<br/>
									<div class="saveBtn" ><input type="submit" value="Save data" id="saveData" name="saveData" class="commonBtn padding5" /><input type="reset" value="Reset" id="resetBtn" class="leftmargin10 commonBtn padding5" /></div>
									</form>
								</div>
						...
						<input type="hidden" name="exportType" value="termInfo"/> 
							<div class="topmargin10"><p class="bold">Filter by: <select class="exprtCatSlct text178" name="exportBy"></select></p></div>
							...
							<div class="topmargin15"><input type="button" value="Get terms list" class="commonBtn disabledBtn" id="getFilteredList" disabled="disabled" />  </div>
							...
							<div id="waiting"></div>
							<div style="padding-top: 5px;"><p class="bold">Select file format to export:
									<select class="width160 exportFormat" name="exportFormat">
										<option>CSV</option>
										<option>TAB</option>
										<option>TBX</option>	
									</select>  
									<img src="<%=application.getContextPath()%>/images/document_export.png" height="35px" width="35px;" class="export" alt="Click to Export" title="Click to Export" style="vertical-align: bottom; margin-left: 30px;cursor:pointer;" /></p>  
							</div>
							</form>
						</div>
					...
					<div id="uploadTMXFormId" >
								<form>
									...
									<div class="topmargin5"><input type="file" size="40" name="upload" id="importTMXTerm" style="font-size:12px;"/> <input type="image" src="<%=application.getContextPath()%>/images/document_import.png" height="35px" width="35px;" alt="Click to Import file" title="Click to Import file" style="vertical-align: bottom; margin-left: 30px;cursor:pointer;" id="importTMXFile">   </div>
								</form>
								</div>
							<div id="uploadTMxId" class="nodisplay" style="color: #00A4D6;margin-top: 5px;cursor:pointer;">Upload another file</div>
								
								<div class="topmargin20 nodisplay" id="impUrl"><a  class="nextEnable topmargin15 "  style="color: #00A4D6;margin-top: 5px;text-align: center;" href="import_export_status.jsp">Click  here to check Imported File status</a></div>
								
						</div>
						<div id="tabs-5"class="border-aln">
							<input type="hidden" name="exportTMXType" value="termInfo"/> 
							<div class="topmargin10"><p class="bold">Filter by: <select class="exprtCatTMXSlct text178" name="exportTMXBy"></select></p></div>
							...
							<div class="topmargin15"><input type="button" value="Get TM list" class="commonBtn disabledBtn" id="getFilteredTMXList" disabled="disabled" /> </div>
							<iframe id="downloadFrame" name="downloadFrame" height="0" width="0" frameborder="0" scrolling="yes"></iframe>              
							<form id="downloadTMXForm" name="downloadFrame" method="post" target="downloadFrame" action="<%=application.getContextPath()%>/impExp_serv" >
									<div style="text-align: left;" class="topmargin25">
							<input type="hidden" name="c" value="exportTMX"/>
							<input type="button" value="Export TM" class="commonBtn" name="exportTMX" id="exportTMX" style="padding:3px 10px;" /> 
							<input type="hidden" name="fileIdExport" value="" id="fileIdExport"/>
							<div class="topmargin15"><a target="_blank" class="nextEnable topmargin15 nodisplay" id="expUrl" style="color: #00A4D6;margin-top: 5px;text-align: center;" href="import_export_status.jsp">Click  here to check Exported File status</a></div>
						 </div>
								</form>
						...
						<div id="tabs-6" style=" margin-right: 33px; margin-left: -7px;">
						
						 	<div class='reportHeader' >
						<div class='left'>
							<div class="headerTxt leftpadding25" style="width:250px;"><div id="totalTMTerms" ></div>
					...
					</div><div class="smallFont padding5" style="text-align:right;" id="viewRprt"></div>
			...
			<div class='rightContainer'>
				<div class='invitePpl bottommargin10'>
					...
					<div class="smallFont topmargin10" style="margin-right: 5px;"><div class="floatleft"style="margin-top: 3px;"><input type="checkbox" id="chkCase" name="chkCase" /></div> <div class="topmargin5 floatleft" >Case sensitive</div></div>
					<div style="text-align: right;margin-right: 5px;"><input type='button' id='searchTerm' value='Search'  /></div>
				</div>
				...
				<div id="termImage" class="nodisplay" >
					<div  style="width:100px; border:1px solid #cccccc;height: 100px;margin-top: 97px;margin-left: 1px;"><img width="100px" height="100px" id="uploadedImage" src="<%=application.getContextPath()%>/images/default.jpg" /></div>
					<div class="topmargin10 alignCenter"><a href="javascript:;" class="changePic" style="font-size: 12px;padding-right: 161px;">Add term picture</a></div>
					</div>
			</div>
			<div class='clear'></div>
                   ...
                   <option value="100">100</option>
					...
					<div id="manageTermTbl" class='bottommargin10 topmargin15'>
						<div id='mngTrmDtlSectionHead'>
					        <div id='column0' class='width25'><input type="checkbox" id="selectAll" title="Select all" style="margin-top:1px;margin-left:-12px;"/></div>
							<div id='targetTerm' class='width110' sortOrder="ASC">Terms being polled</div>
                            ...
                            <!-- <% if (isSuperAdmin) { %> -->
							<!-- <div id='company' class='width80 viewCompany nodisplay' sortOrder="ASC" >Company</div> -->
                            <!-- <% } %> -->
                            <div id='status' class='width80' sortOrder="ASC">Status</div>
							<div id='termEdit' class='width40 aligncenter' sortOrder="ASC">Edit</div>
			...
			<div class="topmargin15 nodisplay" id="tmModule" style="padding-left: 40px;">
					<div class="topmargin10 langSlctDropdwn bottommargin10 TmLangSlctDropdwn">
						<select size="5" name="example-basic" multiple="multiple" title=" select language" id="tmLanguageSlct"></select>
					</div>
						<div class="topmargin10 companyTmsSlctDropdwn companyFilter bottommargin10 ">
									<select size="5" name="example-basic" multiple="multiple" title="select company" id="companyTmsSlct"></select>
								</div>
					<div  class="bottommargin10 tmsBtn"  style="text-align: right;width:950px;">
						<input type="button" value="Delete Selected" class="commonBtn" name="deleteMultipleTerms" id="deleteMultipleTms" style="padding:3px 10px;" />&nbsp;&nbsp;
						<input type="button" value="Delete All" class="commonBtn" name="deleteAllTms" id="deleteAllTms" style="padding:3px 10px;" />
					...
					<div id="manageTmTbl" class='bottommargin10 topmargin15'>
						<div id='mngTmDtlSectionHead'>
							 <div id='column0' class='width30'><input type="checkbox" id="selectAllTms" title="Select all" style="margin-top:1px;margin-left:-12px;"/></div>
    ...
    <div id="invitation" title="Invite to vote" class="nodisplay leftpadding15">
		<form id="termVoteForm">
			<div class="topmargin5">
			<label for="categorySlct" class="error floatleft nodisplay" style=" margin-left: 40px;" generated="true"></label><div class="clear"></div>
			<p class="bold">Select: <select class="categorySlct text178" id="categorySlct" name="categorySlct"><option value="">--Select--</option><option value="role">Role</option><option value="language">Language</option><option value="domain">Domain</option></select></p><div class="nodisplay redTxt leftmargin100 " id="usersReq" style="padding-left:40px ">Select any one category to invite users</div></div>
        ...
        <p class="topmargin25 alignCenter" id="ptag "><span class="ui-icon ui-icon-alert termMsg" style="display: inline-block; margin: 2px -4px -4px;"></span>&nbsp;Are
    ...
    <div id="mail_failed" title="Failure" class="nodisplay">
        <p><span class="ui-icon ui-icon-circle-check termMsg" style="display: inline-block; margin: 24px -13px -18px 1px;"></span> &nbsp;&nbsp;
            <span id="failmsg" style="display: inline-block;margin-left: 17px;"></span> <span id="failedUserEmail"></span>.</p>
    </div>
    ...
    <div id="downloadProgressMsg" title="Alert" class="nodisplay">
		...
		<div id="termImprtInfo" class="nodisplay" title="Import Termbases Status">
				...
				<div id="downloadTmpltFile" class="topmargin15 nodisplay">Please download the sample csv import template<span class="logFile nextEnable leftpadding15" >Download</span></div>
				<div id="downloadTBXTmpltFile" class="topmargin15 nodisplay">Please download the sample TBX import template<span class="logFile nextEnable leftpadding15" >Download</span></div>
			  <div id="downloadTABTmpltFile" class="topmargin15 nodisplay">Please download the sample TAB import template<span class="logFile nextEnable leftpadding15">Download</span></div> 

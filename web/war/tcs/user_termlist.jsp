  	  ...
  	  %>
 		<div class='contentContainer'>
			...
			<!-- <div class="rightpadding15"><span class="countTxt"><span id="totalLangTerms" class="floatright"></span><br /><span class="smallFont floatright">terms</span></span></div><br class="clear" /> -->
				...
				<div class="bottommargin10 showTermsVoted" style="text-align: right;margin-right: 31px;font-size: 12px;top: 8px;right: 17px;" ><a href="javascript:;" class="votedTrms" style="padding-right: 11px;position: relative; top: 8px;">Show Terms I've Voted On</a><a href="javascript:;" style="position: relative;top: -10px;" class="currentPolls nodisplay">Show current invitations</a></div>

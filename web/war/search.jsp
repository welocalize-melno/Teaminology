...
%>
				<div class="contentContainer" style="padding-left: 50px; padding-top: 50px;">
         ...
         <div id="searchText"  >
			...
			<div >
				...
				<div class="sendRequestMail topmargin10" style="padding-left:154px;">
					...
					<input type="button" value="Cancel" id="cancelRequestMail"  name="cancelRequestMail" class="cancelMailBtn commonBtn padding5" style="border: 1px solid rgb(174, 174, 174); background-color: rgb(174, 174, 174); font-family: HP Simplified;"/>
				</div>
					</div>
				</form>
			</div>

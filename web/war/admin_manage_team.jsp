...
<body class="adminOvr">
    ...
    %>
		<div class='contentContainer'>
			...
			<div class='rightContainer floatright' style="margin-top: 18px; margin-right: 18px;float: right;">
				<div class='invitePpl bottommargin10' style="min-height:85px;">
			...
			<div class="topmargin20 langSlctDropdwn">
						<select size="5" name="example-basic" multiple="multiple" title="select language" id="mainLanguageSlct"></select>
				</div>
        ...
        <div class="alignRight bottommargin10" style="padding-right: 12px;">
        ...
        <div class="topmargin15" id="teamListModule" style="padding-left: 28px;padding-right: 12px;">
            <div id="manageTeamTbl" class='bottommargin10 topmargin15'>
                <div id='teamListSectionHead'>
                    <div id='column0' class='width20'>
                        <input type="checkbox" id="selectAll" title="Select all" style="margin-left: -1px; margin-top: 1px;"/></div>
        ...
        <form id="registerForm">
            <div class="regFrm topmargin30">
                <div class='boxWidth320'>
                    ...
                    <label for="email" class="error floatright nodisplay teamlabel" generated="true"></label>
                    <div class="clear"></div>
                    ...
                    <div class="bottommargin15 addCompanyUser addallUser  nodisplay" id="hideCompanySlct">
                        <div class="label width110 floatleft">Company<span class="redTxt">*</span>:</div>
                        <select disabled id="company" name="company" tabindex="8" style="width:195px">
                            <option value="0">---Select company---</option>
                        </select>
                    </div>
					
                    <div class="bottommargin20 ">
                        <div class="label width110">Domain:</div>
                        <select id="domain" tabindex="10" style="width:195px">
                ...
                <div class='boxWidth320'>
                    ...
                    <div class="floatright nodisplay teamselecterror">
                         <span class="error languageSlctErr">Select at least one language</span>
                    </div>
                    ...
                    <div class="bottompadding20">
                        ...
                        <div class="floatleft">
                            <select id="role" name="role" tabindex="4" style="width:60px">
                ...
                <div id="editUserBtns" class="teamButton">
                    ...
                    <input id="cancelAddUser" type="button" name="resetBtn" tabindex="13" value="Cancel" class="loginBtn leftmargin25"/>
                </div>
            </div>
        </form>
    </div>

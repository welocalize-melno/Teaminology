...
<div class='header'>
    ...
    <% if (!isHpCompany) { %>
     <div class='leftIcon' style="width: 60px;">
        <img alt="Logo" src="<%=application.getContextPath()%>/images/canada_logo.png">
    </div>
...
<!-- <a href="http://www.hp.com" target="new window" id="about"  style="float: left; color: rgb(90, 90, 90); padding-top: 31px; cursor: pointer; margin-left: -180px; font-family: HP Simplified; font-size: 16px;">ABOUT </a> -->
        <div class="signUpButton showhide" style="color: #5A5A5A; float: none;display:inline; cursor: pointer; margin-left: 30px;color: #FFF;background-image: none;"> LOG IN </div>
    ...
    <div class='clear'></div>
    <% } else { %>
    <div class="leftIcon"  style="padding-top: 25px; width: 28px;">
        <img alt="[get this text from configuration file]" src="/app/images/canada_logo.png">
    </div>
...
<!-- <div style="color: rgb(227, 122, 83); padding-left: 401px; display:none" class="newRank"> Congratulations!! You got new rank </div> -->
	...
	<h1 class="tagline">Teaminology is The place to identify, approve and standardize</h1>
	<h1 class="tagLineForHome" style="">Terminology  through crowdsourcing</h1>

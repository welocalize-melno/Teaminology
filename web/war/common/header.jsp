...
<div class='header'>
    ...
    <% if (!isHpCompany) { %>
     <div class='leftIcon' style="width: 60px;">
        <img alt="Logo" src="<%=application.getContextPath()%>/images/apple_logo.jpg">
    </div>
...
<!-- <div style="color: rgb(227, 122, 83); padding-left: 401px; display:none" class="newRank"> Congratulations!! You got new rank </div> -->
	...
	<h1 class="tagline">Teaminology is the place to identify,</h1>
	<h1 class="tagLineForHome" style="">approve and standardize  terminology through crowdsourcing</h1>

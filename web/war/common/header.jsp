...
<%
   ...
   // String loginStatus = request.getParameter("msg");
    ...
    if (request.getRequestURI().indexOf("/demo/") > 0 || request.getRequestURI().endsWith("/demo")) {
        isHpCompany = true;
        companyId = "2";
        pageUrl += "/demo/";
...
<!-- <a href="http://www.hp.com" target="new window" id="about"  style="float: left; color: rgb(90, 90, 90); padding-top: 31px; cursor: pointer; margin-left: -180px; font-family: HP Simplified; font-size: 16px;">ABOUT </a> -->
    ...
    <% } else { %>
    <div class="leftIcon">
        <img alt="[get this text from configuration file]" src="/app/images/logo.png">
    </div>
...
<!-- <div style="color: rgb(227, 122, 83); padding-left: 401px; display:none" class="newRank"> Congratulations!! You got new rank </div> -->
    ...
    <h1 class="tagline">The Teaminology Community is THE place to identify,</h1>
    <h1 class="tagLineForHome" style="">approve and standardize teaminology through crowdsourcing</h1>

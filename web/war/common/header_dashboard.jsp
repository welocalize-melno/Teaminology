...
<div class='header'>
    ...
    <% } else { %>
    <div class="leftIcon">
        <img alt="[get this text from configuration file]" src="/app/images/logo_hpe.png">
    </div>
    <div class='headerMenu'>
        <div class='menuHeading'>
...
<div class='subMenu'>
	...
	<h1 class="tagline floatleft">The HP Terminology Community is THE place to identify, approve and </h1>

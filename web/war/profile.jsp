...
%>
		...
		<div class='leftContainer' style="margin-top: 32px;">
						...
						<form id="changeForm">
							<div class="topmargin10">
								...
								<span class="nodisplay redTxt floatleft error"  style="padding-left: 136px" id="emailReq">Enter current password</span>
									...
									<div class="saveBtn" style="margin-left: 135px;margin-top: 20px;"><input type="button" value="Save" id="updatePwd" class="commonBtn padding5" /><input type="reset" value="Cancel" class="leftmargin20 commonBtn padding5" id="cancelBtn"/></div> 
								</div>

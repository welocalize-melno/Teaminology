...
<body>
	...
	<%@include file="../common/header.jsp"%>
		...
		<div class='contentContainer'>
			<h1>Reports</h1>
			<div style="text-align: right; padding-right: 147px;" class="bottommargin10">
			...
			<div class="momChart" style="border:1px solid #dddddd;height:315px; width:950px;margin-bottom: 15px;padding-left: 1px; background-color: #F1FFEA;">
				...
				<div class='boxWidth235' id="trmsInGlossary" style='border:1px solid #dddddd;padding-left: 6px;'>
				...
				<div class='boxWidth235 leftmargin10' id="debatedTrms" style='border:1px solid #dddddd;padding-left: 6px;'>
				...
				<div class='boxWidth385 leftmargin10' id="langTrms" style='border:1px solid #dddddd;padding-left: 6px;'>
            ...
            <div class='clear'></div>
				...
				<div class='boxWidth235 topmargin20' id="tmsInGlossary" style='border:1px solid #dddddd;padding-left: 6px;'>
				...
				<div class="topmargin20">
					<div id="reportsTbl" class='bottommargin10 topmargin15'>
						<div id='reportsHead' class="tblHead" style="width: 950px; padding-left: 16px;">
						...
						<div id='teamRowsList' class="tblData" style="width: 950px;">
						</div>

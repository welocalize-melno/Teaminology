...
<div class='siteContainer'>
    ...
    <div class="topmargin15" id="termsModule">
        ...
        <!--
        <div id="termCompanySlct" class="topmargin10 companyTermsSlctDropdwn  bottommargin10 nodisplay" style="display: none">
            <select size="5" name="example-basic" multiple="multiple" title=" select company"
                    id="companyTermsSlct"></select>
        </div>
               -->
        <div class="bottommargin10 termsBtn" style="text-align: right;width:950px;">
            <span style="float: left; padding-left: 4px;padding-top: 5px;"><input id="showSelectedTerms"
                                                                                  style="padding-left: 10px"
                                                                                  type="checkbox"/><span
                    style="font-size: 13px; font-weight: bold; "> Show Selected Terms</span></span>
            ...
            <input type="button" value="Delete Selected" class="commonBtn" name="deleteMultipleTerms"
                   id="deleteMultipleTerms" style="padding:3px 10px;"/>&nbsp;&nbsp;
        ...
        <div id="manageTermTbl" class='bottommargin10 topmargin15'>
            <div id='mngTrmDtlSectionHead'>
                <div id='column0' class='width25'><input type="checkbox" id="selectAll" title="Select all"
                                                         style="margin-top:1px;margin-left: 7px;"/></div>
                <div id='targetTerm' class='width110' sortOrder="ASC" style="white-space: nowrap;margin-left: 15px;">Terms being polled</div>
                <div id='column2' class='width40'>&nbsp;</div>
                <div id='suggestedTerm' class='width90' sortOrder="ASC" style="white-space: nowrap">Top suggestion</div>
            ...
            <div id="pagination" class="pageination">
                <div style="color: #999999; float:left">Viewing <span id="rangeOfTerms">0 </span> of <span
                        id="totalPolledTerms">0</span></div>
                <div style="float: right;"><span class="rightmargin5 termprevious">Previous</span> | <span
                        class="leftmargin5 termNext">Next</span></div>
            </div>
        </div>

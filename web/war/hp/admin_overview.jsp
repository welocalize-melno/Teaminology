<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import= "com.teaminology.hp.service.enums.TeaminologyPage,
                                  ...
                                  java.util.List"%>
<%@ page import="com.teaminology.hp.bo.*" %>
...
<body class="adminOvr">
    ...
    <div class='contentContainer'>
        ...
        <div class='leftContainer'>
            ...
            <div>
                <h2 class='rightmargin20'>Expired polls</h2><span class='smallFont'>There are <span
                    class="moreNum"> </span> expired polls to decide on. <span class='expiredPolls'></span></span>
                ...
                <div class="topmargin10 companyTermsSlctDropdwn companyFilter nodisplay bottommargin10 ">
                    <select size="5" name="example-basic" multiple="multiple" title="select company"
                            id="companyExpiredTermsSlct"></select>
                </div>
                ...
                <div id='termDetails' class='bottommargin10'>
                    <div id='trmDtlSectionHead'>
                        ...
                        <div id='pollExpirationDate' class="width160" sortOrder="ASC">Poll expiration</div>
                    </div>
  ...
  <!-- leader board -->
            <div class='topmargin12' id='leaderBoard'>
				...
				<!-- <span class="topmargin10 langSlctDropdwn bottommargin10 termLangSlctDropdwn style="color: gray; font-family: hp simplified;position: relative; top: -27px; left: 180px;">EN
					<select size="5" name="example-basic" multiple="multiple" title=" select language"
                    id="termlanguageSlctForRank"></select>
                    <i class="fa fa-caret-down" style="color: rgb(24, 158, 198) ! important;cursor: pointer;"></i>
				</span> -->
    ...
    <div id="hpCommunityList" class="nodisplay" title="HP's Community">
    ...
    <div id="mail_success" title="Success" class="nodisplay">
        <p class="topmargin15" style="margin-top:55px; margin-left:55px"><span class="ui-icon ui-icon-circle-check"
    ...
    <div id="invitation" title="Invite people to the community" class="nodisplay" style="padding-left:15px;">
        ...
        <div class="nodisplay redTxt leftmargin100" id="templateReq" style="padding-left:87px;margin-bottom: -15px;">
 ...
 <div style="display: none;" id="historyDetailsDiv" title="History details">
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="historyDetailsTab" width="100%">
            ...
            <th width="10%">Concept example</th>
            <th width="9%">Date</th>
            </thead>
            <tbody>

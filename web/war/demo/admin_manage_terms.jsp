    ...
    <div id="sourceInfo" class="topmargin15 bottommargin10">
        ...
        <div class="left topmargin5">
        	<div style="padding-bottom: 7px">
                <div class="label">Source language<span class="redTxt">*</span>:</div>
                <label for="srcLang" class="error nodisplay" style="float:left;"
                        generated="true"></label>

                <div class="clear"></div>
                <select class="text250 language" name="srcLang" id="srcLang">
                    <option value="">--Select--</option>
                </select>
            </div>
            
            <div>
                <div class="label">Source Term<span class="redTxt">*</span>:</div>

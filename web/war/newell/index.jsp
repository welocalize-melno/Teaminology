...
%>
    ...
    <div class='contentContainer'>
       <%-- <div class="invalidDtls redTxt" style="text-align: center;"><%=lostSession%></div> --%>
       <%-- <div class="invalidDtls redTxt" style="text-align: right;"><%=lostSession%></div>  --%>
		<div class='clear'></div>
        <div style="text-align:center;">
         ...
         <%-- <div class='leftContainer'>
            <div class="floatleft priodLinks">
                Select interval: <span id="yearly" class="off">Yearly</span> |
                <span id="quarterly" class="off">Quarterly</span> |
                <span id="monthly" class="off" style="border-right: medium none;">Monthly</span>
            </div>
            <div class='clear'></div>
            <div class='boxWidth270 leftpadding25'
            ...
            <div class='boxWidth270 leftmargin25 leftpadding25'
                 style='border:none;background-image:url("<%=application.getContextPath()%>/images/ovrvwChrtBg.jpg");background-repeat:repeat-x;'>
      ...
      <div class='tagCloudContainer'>
        ...
        <div class='rightContainer' style='padding-top: 30px; float:right;'>
    ...
    <div class="PopupDiv" style="display:none;">
        ...
        <form id="loginForm" action="<%=application.getContextPath()%>/newell/login" method="post" name="loginFrm"
            ...
            <div style="padding-bottom: 40px;">
                ...
                <div class="floatleft"><input type="text" id="username" name="username" class="text190" maxlength="30"/>
                </div>
            </div>

            ...
            String root=invite.getCompanyRoot();
               if(companyId !=null  && companyId ==1){
                if (invite.getTermIds().length != 0) {
                	String link=companyHost+companyContext+"/"+"user_termlist.jsp";
                    body += "<a href='" + link + "'>Vote</a>";
                }
                     }
               else
               {
            	 String  userLinkCompany=companyHost+companyContext+"/" + root+"/"+"user_termlist.jsp";
            	   if (invite.getTermIds().length != 0) {
                ...
                for (String to : toArray) {
                    ...
                    if(emailTemplate.getEmailTemplateId().intValue()==19){
                        ...
                        String root1=invite.getCompanyRoot();
                           ...
                           {
                        	 String  userLinkCompany=companyHost+companyContext+"/" + root1+"/"+"user_termlist.jsp";
                        	   if (invite.getTermIds().length != 0) {

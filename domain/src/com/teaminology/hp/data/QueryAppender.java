...
public class QueryAppender implements TeaminologyObject
{
	...
	private String isReplaceTerm;
	private String searchReplacedTerm;
...
//	}
	...
	public String getIsReplaceTerm() {
		return isReplaceTerm;
	}

	public void setIsReplaceTerm(String isReplaceTerm) {
		this.isReplaceTerm = isReplaceTerm;
	}

	public String getSearchReplacedTerm() {
		return searchReplacedTerm;
	}

	public void setSearchReplacedTerm(String searchReplacedTerm) {
		this.searchReplacedTerm = searchReplacedTerm;
	}

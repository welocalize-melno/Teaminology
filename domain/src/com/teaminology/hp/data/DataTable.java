...
public class DataTable implements Serializable
{
    ...
    private List<HistoryDetailsData> historyData;
	...
	public List<HistoryDetailsData> getHistoryData() {
		return historyData;
	}

	public void setHistoryData(List<HistoryDetailsData> historyData) {
